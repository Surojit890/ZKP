...
**Total Test Coverage**: 39 test cases across 5 test files
...
```
tests/
├── test_backend.py          # Backend unit tests (16 tests)
├── test_vectors.py          # Test vectors & integration (3 tests)
...
| -------------- | ------------------------ | ----- | ------------------ |
| Backend Unit   | `test_backend.py`        | 16    | API functionality  |
| Test Vectors   | `test_vectors.py`        | 3     | Crypto correctness |
